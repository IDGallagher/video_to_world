...
def main(config: FrameToModelICPConfig):
    ...
    (
        ...
        conf_mask_min_depth_range_percent=config.alignment.conf_mask_min_depth_range_percent,
        conf_min_depth_range_percent=config.alignment.conf_min_depth_range_percent,
        conf_mask_min_depth_range_meters=config.alignment.conf_mask_min_depth_range_meters,
        conf_min_depth_range_meters=config.alignment.conf_min_depth_range_meters,
